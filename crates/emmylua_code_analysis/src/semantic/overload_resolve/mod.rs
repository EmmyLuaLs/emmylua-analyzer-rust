mod collect_callable_overloads;
...
use super::{
    LuaInferCache,
    generic::infer_call_func_generic,
    infer::{InferCallFuncResult, InferFailReason, infer_expr_list_types, try_infer_expr_no_flow},
};

pub(crate) use collect_callable_overloads::collect_callable_overload_groups;
...
fn resolve_signature_by_generic(
    ...
    for func in overloads {
        let instantiate_func = infer_call_func_generic(db, cache, &func, call_expr.clone())?;
