...
use super::ConstructorReturnMode;

// use crate::{
//     LuaFunctionType, LuaOperatorMetaMethod, LuaType, LuaTypeDeclId, callable_accepts_args,
//     is_sub_type_of,
// };
        ...
        Some(LuaConstructorAttribute {
            ...
            return_mode: match self.get_param_by_name("return_mode") {
                Some(LuaType::DocStringConst(value)) => {
                    ConstructorReturnMode::from_name(value.as_ref())?
                }
                _ => ConstructorReturnMode::Default,
            },
        })
    }
...
pub struct LuaConstructorAttribute<'a> {
    ...
    /// Whether to strip the `self` parameter.
    pub strip_self: bool,
    /// Constructor return strategy.
...
mod tests {
    ...
    use super::{
        ConstructorReturnMode, LuaAttributeUse, LuaFieldAccessorConvention, LuaLspOptimizationCode,
    };
    use crate::{LuaType, LuaTypeDeclId};
    ...
    fn constructor_attribute_uses_builtin_defaults() {
        ...
        assert_eq!(constructor.return_mode, ConstructorReturnMode::Default);
    }
    ...
    fn constructor_attribute_supports_string_return_mode() {
        ...
        let constructor = attribute.as_constructor().unwrap();
        assert_eq!(constructor.return_mode, ConstructorReturnMode::Doc);
    }
