...
pub use query::{
    ...
    SalsaDocOwnerResolveSummary, SalsaDocTagNameContentSummary, SalsaDocTagPropertyEntrySummary,
    SalsaDocTagPropertySummary, SalsaDocTagQueryIndex, SalsaDocTypeLoweredGenericParam,
    SalsaDocTypeLoweredIndex, SalsaDocTypeLoweredKind, SalsaDocTypeLoweredNode,
    SalsaDocTypeLoweredObjectField, SalsaDocTypeLoweredObjectFieldKey, SalsaDocTypeLoweredParam,
    ...
    SalsaPropertyQueryIndex, SalsaResolvedDocDiagnosticActionSummary, SalsaSemanticGraphQueryIndex,
    SalsaSemanticGraphSccComponentSummary, SalsaSemanticGraphSccIndex,
    SalsaSemanticTargetInfoSummary, SalsaSemanticTargetQueryIndex, SalsaSemanticTargetSummary,
    SalsaSignatureExplainIndex, SalsaSignatureExplainSummary, SalsaSignatureGenericExplainSummary,
