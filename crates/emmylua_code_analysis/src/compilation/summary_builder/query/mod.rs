...
pub use decl_member::{SalsaDeclQueryIndex, SalsaMemberQueryIndex};
pub(crate) use decl_member::{
    build_decl_query_index, build_member_query_index, find_decl_by_syntax_id_in_index,
    find_member_by_syntax_id_in_index,
};
pub use doc_owner::{
    SalsaDocOwnerResolutionSummary, SalsaDocOwnerResolveIndex, SalsaDocOwnerResolveSummary,
};
pub(crate) use doc_owner::{
...
pub use doc_tag::{
    ...
    SalsaDocTagQueryIndex, SalsaResolvedDocDiagnosticActionSummary,
};
...
pub(crate) use doc_type::{
    ...
    find_lowered_doc_type_at, find_lowered_doc_type_by_key, find_resolved_doc_type_at,
    find_resolved_doc_type_by_key, find_resolved_doc_type_by_key_from_parts,
    find_type_def_by_name_in_index,
};
pub use flow::SalsaFlowExactLookupIndex;
pub(crate) use flow::{
...
pub(crate) use lexical::{
    build_lexical_use_index, collect_call_references_for_member_in_index,
...
pub(crate) use table_shape::{
    build_table_shape_query_index, find_table_shape_at_in_index,
    find_table_shape_by_syntax_id_in_index,
};
pub use type_system::{
