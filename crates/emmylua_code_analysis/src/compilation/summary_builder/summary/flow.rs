...
use super::super::SalsaLookupBucket;
use crate::{
...
pub struct ConditionNodeId(pub u32);

impl From<u32> for ConditionNodeId {
    fn from(v: u32) -> Self {
        Self(v)
    }
}
impl From<ConditionNodeId> for u32 {
    fn from(v: ConditionNodeId) -> Self {
        v.0
    }
}
...
pub struct SalsaFlowConditionSummary {
    pub node_offset: ConditionNodeId,
    pub syntax_offset: TextSize,
    pub syntax_id: LuaSyntaxId,
    pub kind: SalsaFlowConditionKindSummary,
    pub left_condition_offset: Option<ConditionNodeId>,
    pub right_condition_offset: Option<ConditionNodeId>,
}
...
pub struct SalsaFlowBranchClauseSummary {
    ...
    pub condition_node_offset: Option<ConditionNodeId>,
...
#[derive(Debug, Clone, PartialEq, Eq, salsa::Update)]
pub struct SalsaFlowContinueSummary {
    pub syntax_offset: TextSize,
    pub block_offset: Option<TextSize>,
}
...
#[derive(Debug, Clone, PartialEq, Eq, salsa::Update)]
pub struct SalsaFlowContinueLinkSummary {
    pub continue_offset: TextSize,
    pub block_offset: Option<TextSize>,
    pub enclosing_loop_offset: Option<TextSize>,
    pub continue_target_block_offset: Option<TextSize>,
}
...
pub struct SalsaFlowQuerySummary {
    ...
    pub continue_links: Vec<SalsaFlowContinueLinkSummary>,
...
pub struct SalsaFlowConditionGraphSummary {
    pub condition_node_offset: ConditionNodeId,
    pub syntax_offset: TextSize,
    pub kind: SalsaFlowConditionKindSummary,
...
pub struct SalsaForRangeIterQueryIndex {
    ...
    pub by_loop_offset: Vec<SalsaLookupBucket<TextSize>>,
}
