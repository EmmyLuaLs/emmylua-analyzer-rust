...
pub struct SalsaDeclId(pub DeclPosition);

impl SalsaDeclId {
    pub fn new(pos: impl Into<DeclPosition>) -> Self {
        Self(pos.into())
    }
...
impl From<DeclPosition> for SalsaDeclId {
    fn from(value: DeclPosition) -> Self {
        Self(value)
    }
}

impl From<TextSize> for SalsaDeclId {
    fn from(value: TextSize) -> Self {
        Self(DeclPosition(value))
    }
}

impl From<u32> for SalsaDeclId {
    fn from(value: u32) -> Self {
        Self(DeclPosition::from(value))
    }
}
