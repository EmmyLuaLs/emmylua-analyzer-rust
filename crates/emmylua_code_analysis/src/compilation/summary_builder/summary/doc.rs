...
pub struct SalsaFileDiagnosticStatus {
    pub disabled_codes: Vec<DiagnosticCode>,
    pub enabled_codes: Vec<DiagnosticCode>,
    pub actions: Vec<SalsaDiagAction>,
}

/// 行级诊断动作
#[derive(Debug, Clone, PartialEq, Eq, Hash, salsa::Update)]
pub struct SalsaDiagAction {
    pub range: TextRange,
